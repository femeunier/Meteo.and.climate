...
```{r DataAssimilation2, fig.cap='XX', out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE, fig.show='hold'}
...
```{r Whatisaclimatemodel, fig.cap='XX', out.width='80%', fig.asp=.75, fig.align='center',echo=FALSE, fig.show='hold'}
