...
<!-- We can also easily refer to Equations, see Eq. \@ref(eq:Eq1). -->
...
\caption{Caption}(\#fig:RadiationAlbedo)
\end{figure}
...
\caption{Caption}(\#fig:ThermalBelt)
\end{figure}
...
\caption{Caption}(\#fig:Humidityterm)
\end{figure}
...
\caption{Caption}(\#fig:Vegetation)
\end{figure}
...
\caption{Caption}(\#fig:ThermalCirc)
\end{figure}
...
\caption{Caption}(\#fig:Monsoon)
\end{figure}

<!--chapter:end:04-Pressure.Rmd-->
...
\caption{Figure caption}(\#fig:Fig511)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig512)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig513a)
\end{figure}
\begin{figure}
...
\caption{Figure caption}(\#fig:Fig513b)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig514)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig521a)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig521b)
\end{figure}
\begin{figure}
...
\caption{Figure caption}(\#fig:Fig521c)
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{figures/Figure522a} \caption{Figure caption}(\#fig:Fig522a)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig522b)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig524a)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig531a)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig531b)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig532a)
\end{figure}
\begin{figure}
...
\caption{Figure caption}(\#fig:Fig532b)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig532c)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig533a)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig533b)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig533c)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig533d)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig533e)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig533f)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig533g)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig534a)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig535a)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig536)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig611)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig612a)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig612b)
\end{figure}
...
\caption{Figure caption}(\#fig:Fig613)
\end{figure}
***Video suggestion:*** https://www.noaa.gov/stories/what-are-atmospheric-rivers
...
\caption{Symbols (half circles, triangles) indicate  the direction of movement of the fronts. Green area is the area of precipitation. Each symbol with wind and temperature info is a weather station. }(\#fig:Fig621)
\end{figure}
...
<!--chapter:end:06-FrontsAndWeatherMaps.Rmd-->



# Extreme events: storms, tornadoes and hurricanes {#introEE}
\chaptermark{Intro}
...
\caption{caption}(\#fig:Thunderstormformation)
\end{figure}
...
\caption{caption}(\#fig:Ordinarycellthunderstorms)
\end{figure}
...
\caption{caption}(\#fig:Multicellthunderstorms)
\end{figure}
...
\caption{caption}(\#fig:Supercellthunderstorms)
\end{figure}
...
\caption{caption}(\#fig:Distributionthunderstorms)
\end{figure}
...
\caption{caption}(\#fig:ElectrificationofClouds)
\end{figure}
...
\caption{caption}(\#fig:Tornadooccurrence)
\end{figure}
...
\caption{caption}(\#fig:SupercellTornadoes)
\end{figure}
...
\caption{caption}(\#fig:SupercellTornadoes2)
\end{figure}
...
\caption{caption}(\#fig:SupercellTornadoes3)
\end{figure}
...
\caption{caption}(\#fig:TropicalCyclones)
\end{figure}
...
\caption{caption}(\#fig:Anatomycyclone)
\end{figure}
...
\caption{caption}(\#fig:developingstorm)
\end{figure}
...
\caption{caption}(\#fig:Stagesofdevelopment)
\end{figure}
...
\caption{caption}(\#fig:TrackingandForecasting)
\end{figure}
...
<!--chapter:end:07-ExtraChapter.Rmd-->

# Forecasting and numerical weather prediction {#introFore}
\chaptermark{Intro}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{figures/Figure71} \caption{Governing systems of equations (Eq(s) 1-7)}(\#fig:GoverningSystemsofequations)
\end{figure}
...
\caption{XX)}(\#fig:PhysicalParameterizations)
\end{figure}
...
\caption{XX)}(\#fig:DataAssimilation)
\end{figure}
...
\caption{XX)}(\#fig:DataAssimilation3)
\end{figure}
...
\caption{XX)}(\#fig:DataAssimilation4)
\end{figure}
...
\caption{XX)}(\#fig:EnsembleForecasting)
\end{figure}
...
\caption{XX)}(\#fig:EnergyBalanceModels)
\end{figure}
...
\caption{XX)}(\#fig:EnergyBalanceModels2)
\end{figure}
...
\caption{XX)}(\#fig:GeneralCirculationModels)
\end{figure}
...
\caption{XX)}(\#fig:Earthsystemmodels)
\end{figure}
...
\caption{XX)}(\#fig:Earthsystemmodels2)
\end{figure}
...
\caption{XX)}(\#fig:Earthsystemmodels3)
\end{figure}


<!--chapter:end:08-NWP.Rmd-->



# (PART) Vegetation-climate interactions {-}

# Global climate & Köppen classification {#introKopen}
\chaptermark{Intro}
...
\caption{caption}(\#fig:Climaticcontrols)
\end{figure}
...
\caption{caption}(\#fig:Globalprecipitation)
\end{figure}
...
\caption{caption}(\#fig:Climateclassification)
\end{figure}
...
\caption{caption}(\#fig:Vegetationzones)
\end{figure}
...
\caption{caption}(\#fig:Vegetationzones2)
\end{figure}
...
\caption{caption}(\#fig:Vegetationzones3)
\end{figure}
...
\caption{caption}(\#fig:Vegetationzones4)
\end{figure}
...
\caption{caption}(\#fig:Vegetationzones5)
\end{figure}
...
\caption{caption}(\#fig:Vegetationzones6)
\end{figure}
...
\caption{caption}(\#fig:Vegetationzones7)
\end{figure}



<!--chapter:end:09-Global_Climate.Rmd-->
